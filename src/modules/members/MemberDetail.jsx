...
import { calculateAttendancePct, getAttendanceColor } from "../../lib/attendanceUtils";
...
export default function MemberDetail() {
  ...
  async function fetchAll() {
    ...
    try {
      ...
      // Total meetings — consistent with members list denominator
  ...
  const attendancePct = calculateAttendancePct(attendedCount, totalMeetings);
  const pctColor = getAttendanceColor(attendancePct);
